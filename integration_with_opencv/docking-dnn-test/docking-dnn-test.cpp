...
int main()
{
	...
	std::string proto = "E:/University/11sem/nirs/NeuralNet/docking_model/graph.pbtxt";
	std::string model = "E:/University/11sem/nirs/NeuralNet/docking_model/saved_model.pb";


	//auto net = cv::dnn::readNetFromDarknet("E:/University/12sem/yolov4.cfg", "E:/University/12sem/yolov4.weights");
	//auto net = cv::dnn::readNetFromTensorflow(model, proto);
	...
	while (cv::waitKey(1) < 1)
	{
		...
		std::cout << detections.size() << " " << detections[0] << "\n";
