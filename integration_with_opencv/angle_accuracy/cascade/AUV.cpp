...
AUV::AUV() {
	...
	*/
	...
	cMatrixFullHD = (Mat_<double>(3, 3) << 1.8319186447786888e+04, 0, 9.5950000000000000e+02,
		0, 1.8319186447786888e+04, 5.3950000000000000e+02,
		0, 0, 1);

	distortionFullHD = (Mat_<double>(1, 5) << 2.5318391279962491e+01, -1.2398130862604572e+04, 0, 0, 2.4952587093051355e+06);
